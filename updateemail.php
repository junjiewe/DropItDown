...
$message .= "http://junjiewe.thecompletewebhosting.com/DropSomethingDown/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for your Drop It Down App', $message, 'From:'.'junjiewe@buffalo.edu')){
